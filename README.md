allOut.m is the base function for importing MedPC txt files and converting all variables and arrays into a structure. This gets run on a folder full of MedPC txt files
